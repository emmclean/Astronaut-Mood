...
HR1 = function() {
  ...
  return heart_rate.html = "<b>Heart Rate</b></br>" + heartnum + " bpm";
};
...
Utils.delay(3, function() {
  ...
  results = [];
  for (i = j = 0; j < 200; i = ++j) {
    Utils.delay(stepper, function() {
      return HR1();
    });
    results.push(stepper = stepper + 3);
  }
  return results;
});
...
HR2 = function() {
  ...
  return blood_press.html = "<b>Blood Pressure</b></br>" + BPnum + " / " + BPdenom;
};
...
Utils.delay(9, function() {
  ...
  results = [];
  for (i = j = 0; j < 300; i = ++j) {
    Utils.delay(stepper2, function() {
      return HR2();
    });
    results.push(stepper2 = stepper2 + 9);
  }
  return results;
});
...
HR3 = function() {
  ...
  return skin_temp.html = "<b>Temperature</b></br>" + tempnum + "F";
};
...
Utils.delay(30, function() {
  ...
  results = [];
  for (i = j = 0; j < 40; i = ++j) {
    Utils.delay(stepper3, function() {
      return HR3();
    });
    results.push(stepper3 = stepper3 + 60);
  }
  return results;
});
...
hand.onLongPressEnd(function() {
  blueAnimation.stop();
  purpleAnimation.stop();
  greenAnimation.stop();
  return blackAnimation.start();
});
